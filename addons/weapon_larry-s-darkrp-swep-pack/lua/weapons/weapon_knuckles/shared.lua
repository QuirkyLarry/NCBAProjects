...
function SWEP:PrimaryAttack()
    ...
    if CLIENT then
        net.Start("KnucklesSound") net.WriteString(SWEPsounds) net.SendToServer()
    end
end

if SERVER then
    util.AddNetworkString("KnucklesSound")
    net.Receive( "KnucklesSound", function( len, ply )
