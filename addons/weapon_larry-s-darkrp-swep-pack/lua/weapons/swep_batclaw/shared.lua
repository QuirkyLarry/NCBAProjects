-- Config
	-- Max Distance that the swep can reach.
local MaxRopeDist = 10000
SWEP.Author			= "Darkfortune, Dorpz (For fixing), MS32 (Batmanning)"
SWEP.Contact		= "dorpzman@hotmail.com"
SWEP.Purpose		= "Batman's grappling hook gun"
SWEP.Instructions	= "Left click to fire Batclaw"
SWEP.Spawnable			= true
SWEP.AdminSpawnable		= true
SWEP.PrintName			= "Batclaw"
SWEP.Slot				= 2
SWEP.SlotPos			= 0
SWEP.DrawAmmo			= false
SWEP.DrawCrosshair		= true
SWEP.Category = "Larry's DarkRP Sweps"
SWEP.ViewModel			= "models/weapons/doom3/v_pistol.mdl"
SWEP.WorldModel			= "models/weapons/doom3/w_pistol.mdl"
SWEP.Primary.Sound = "batclaw/batclaw_sound3.wav"
SWEP.Secondary.Sound = "batclaw/batclaw_hold_sound1.wav"
...
function SWEP:Think()
	...
	if (self.Owner:KeyReleased(IN_ATTACK2)) and CLIENT then
		l_tS(0.31, function()
	...
	if inRange then
		if SERVER then
			if (not self.Beam) then
				self.Beam = ents.Create("swep_batman_rope")
