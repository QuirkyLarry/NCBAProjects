...
function TOOL:LeftClick( trace )
	...
	if ( iNum == 1 ) then
		...
		local forcelimit = 150000

		local nocollide = true

		local deleteent1onbreak = false
		...
		local constraint = constraint.Weld( Ent1, Ent2, Bone1, Bone2, forcelimit, nocollide, deleteent1onbreak )
