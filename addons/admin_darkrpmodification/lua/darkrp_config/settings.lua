...
GM.Config.maxlotterycost                = 2500000
...
GM.Config.startingmoney                 = 250000
...
GM.Config.DefaultLaws = {
    ...
    "Harming a pet is illegal.",
    "Pissing in public is illegal.",
    "Pan-handling in public is illegal.",
}
